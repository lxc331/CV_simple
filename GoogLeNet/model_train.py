...
def deal_train_and_val_data():
    ...
    train_dataloader = data.DataLoader(train_data, batch_size=16, shuffle=True, num_workers=4)
    val_dataloader = data.DataLoader(val_data, batch_size=16, shuffle=True, num_workers=4)
