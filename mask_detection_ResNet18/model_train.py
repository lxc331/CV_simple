...
from torchvision.datasets import ImageFolder # 用来加载图片数据集，自动将图片转换为张量
...
from model import ResNet18, Residual # 从 model.py 中导入 ResNet18, Residual 模型
...
def deal_train_and_val_data():
    ...
    normalize = transforms.Normalize(mean=[0.6035, 0.5434, 0.5141], std=[0.3120, 0.3131, 0.3210])
...
if __name__ == '__main__':
    ...
    ResNet18Model = ResNet18(Residual)
    train_process = train_model(ResNet18Model, train_dataloader, val_dataloader, 30)
